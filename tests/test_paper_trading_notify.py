...
class TestPremarketDedup(unittest.TestCase):
    ...
    def test_premarket_plan_no_signals(self):
        ...
        self.assertIn("No candidate stocks today", body)
...
class TestMessageFormat(unittest.TestCase):
    def test_entry_message_format(self):
        ...
        self.assertIn("Trend Continuation", body)  # 策略名
    ...
    def test_daily_summary_format(self):
        ...
        self.assertIn("End-of-Day Summary", title)
        self.assertIn("Total equity", body)
        self.assertIn("1 position(s) closed today", body)
        self.assertIn("1 position(s) open", body)
...
class TestHelpers(unittest.TestCase):
    def test_strategy_label_known(self):
        ...
        self.assertEqual(_strategy_label("momentum"), "Momentum Strategy")
