"""Strategy catalog and weight lookup."""
...
DEFAULT_STRATEGIES: tuple[StrategySpec, ...] = (
    StrategySpec(
        ...
        description="Follows the trend, favoring bullish MA alignment with continuing momentum",
        risk_level="medium",
    ...
    StrategySpec(
        ...
        description="Confirmed MACD golden cross, leans short-to-medium term",
        risk_level="medium",
    ...
    StrategySpec(
        ...
        description="High-volume breakout above a key level, leans aggressive",
        risk_level="high",
        params={"horizon_days": 3},
        default_weight=1.18,
    ),
    StrategySpec(
        ...
        description="Second launch after a pullback to support",
        risk_level="low",
        params={"horizon_days": 5},
        default_weight=1.05,
    ),
    StrategySpec(
        ...
        description="Bounce trades after an oversold move",
        risk_level="high",
        params={"horizon_days": 3},
        default_weight=0.95,
    ),
    StrategySpec(
        ...
        description="A consolidated mapping of recommendations from the existing agents",
        risk_level="medium",
        params={"horizon_days": 3},
        default_weight=1.00,
    ),
    StrategySpec(
        code="market_scan",
        name="Market Scan",
        description="Market-pool scanning strategy (trending and active stocks)",
        risk_level="medium",
        params={"horizon_days": 3},
        default_weight=1.08,
    ),
