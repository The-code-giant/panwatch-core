...
把 TauricResearch/TradingAgents (多 Agent 投资决策框架,76k star) 适配进 TickerKeep:
- 桥接 TickerKeep AI Service 到 TradingAgents LLM config
- 把 TickerKeep Provider 体系的数据注入 TradingAgents 的 data vendor 层(A 股专用)
- 把 TradingAgents 的 final_state 映射成 TickerKeep 的 AnalysisResult
