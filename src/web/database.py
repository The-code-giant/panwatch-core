...
# DATA_DIR is the same override already honored by src/collectors/chart_renderer.py,
# src/core/universe.py, src/core/intraday_event_gate.py and src/web/api/settings.py
# (all default to "./data"). Honoring it here too means tests/conftest.py can point
# an isolated pytest run at a disposable directory at IMPORT time — before this
# module's module-level create_engine() call ever touches a real installation's
