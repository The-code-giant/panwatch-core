...
- Fresh installation: follow README using a new Compose project and loopback port 18080.
- Tests: follow CONTRIBUTING; disposable source-only Docker copies, network denied, schedulers disabled, mocked providers only.
