        ...
        <div className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <Input value={form.name} onChange={e => setForm(prev => ({ ...prev, name: e.target.value }))} placeholder="e.g. Breakout above 120 alert" />
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div>
              <div className="text-[12px] text-muted-foreground mb-1">Condition logic</div>
            ...
            <div>
              ...
              <Select value={form.market_hours_mode} onValueChange={(v) => setForm(prev => ({ ...prev, market_hours_mode: v as any }))}>
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
                  <SelectItem value="trading_only">Trading hours only</SelectItem>
            ...
            <div>
              <div className="text-[12px] text-muted-foreground mb-1">Daily cap</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <Select value={form.repeat_mode} onValueChange={(v) => setForm(prev => ({ ...prev, repeat_mode: v as any }))}>
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
                  <SelectItem value="repeat">Can trigger repeatedly</SelectItem>
                  <SelectItem value="once">Trigger once only</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div>
              <div className="text-[12px] text-muted-foreground mb-1">Expiration (optional)</div>
              <div className="grid grid-cols-2 gap-2">
                <div className="relative">
                  ...
                  {calendarOpen && (
                    <div className="absolute z-50 mt-1 w-[260px] rounded-xl border border-border/60 bg-card p-2">
                      <div className="flex items-center justify-between mb-2">
                        <Button type="button" variant="ghost" size="sm" className="h-7 w-7 p-0" aria-label="Previous month" onClick={() => setCalendarMonth(prev => new Date(prev.getFullYear(), prev.getMonth() - 1, 1))}>
                          <ChevronLeft className="w-3.5 h-3.5" />
                        </Button>
                        <div className="text-[12px] font-medium">{monthLabel}</div>
                        <Button type="button" variant="ghost" size="sm" className="h-7 w-7 p-0" aria-label="Next month" onClick={() => setCalendarMonth(prev => new Date(prev.getFullYear(), prev.getMonth() + 1, 1))}>
